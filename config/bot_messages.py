...
"\n" \
"\n" \
"1. /set X <кол-во минут> - выбрать время и включить таймер. Каждые X минут я буду отправлять вам список ваших дел." \
"\n" \
"2. /stop - остановить таймер." \
"\n" \
"3. /add <Новое задание> - Добавить новое задание в список дел." \
"\n" \
"4. /showtasks - Показать все ваши задания." \
"\n" \
"5. /delete <Номер задания> - удалить определенное задание." \
"\n" \
...
clear_command_confirmation = "Вы уверены что хотите очистить весь ваш список задач (Да/Нет)? 🗑"
...
checked_todo_list_words = "\nЕсли вы выполнили что-то из этого, можете написать /delete <номер задания> чтобы удалить задание 😉"
...
delete_task_write_task = "Окей, напишите номер задания которое нужно удалить 🗑:" \
"\n" \
"\n" \
"/cancel - отменить операцию."
...
guide_set_timer = "Круто 🥳! Ты можешь поставить таймер использую команду /set."
